...
- **更新频率：** 每月复核并更新一次，覆盖全部方案分类。
- **最近一次全库内容复核基准：** 2026-09-02

核验时间统一在本首页说明，各子页面保留项目状态、证据等级和官方来源。仅在完成全库核心内容的官方来源复核后推进上述基准；排版、维护规则调整和网站重新部署不算内容复核。部分页面完成更新时，记录于[更新记录](./CHANGELOG.md)，全库基准保持不变。

月度更新无法覆盖月内所有即时变化，递件或付款前仍须查看主管机关最新规则。具体维护办法见[更新政策](./UPDATE_POLICY.md)。
