...
- Followed up on Taiwan digital-nomad eligibility: made actual visa-exempt eligibility a prominent prerequisite, added passport/birthplace/citizenship-class exceptions from the linked official list, and sourced the 2026 rules and annex from the government gazette. Corrected the dependent-child scope and the annex warning about extension after a stay of less than six months. Also added Colombia’s conditional visa-exemption rules and marked their application to the digital-nomad visa unresolved (A to B). The current identity ledger has 64 documented and 80 partial blocks; the 7 core gaps and 30 historical blocks are unchanged. Added a linked-list and prerequisite-versus-alternative review rule; retained the existing full-review baseline.
- Added an applicant-identity field to all 181 program blocks across 173 policy pages, separating nationality/passport, foreign permanent residence, current immigration status, consular jurisdiction, and the roles of applicants, guardians and sponsors. The initial [identity audit](https://github.com/Garylauchina/global-mobility-handbook/blob/main/.maintenance/reviews/2026-09-09-applicant-identity/README.md) recorded 65 blocks with documented conditions, 79 with partial evidence, 7 with unresolved core identity evidence, and 30 historical/non-actionable blocks; it does not advance the full-content review baseline. Added field validation and contribution guidance; lowered Cyprus investor PR to B for the identity evidence gap.
...
- Organized current schemes by route type, then country or territory.
- Added a separate warning area for closed, paused, replaced, and unverified programs.
- Added evidence grades, source URLs, verification dates, disclaimer, methodology, and contribution rules.
- Added a searchable, Chinese-first GitHub Pages site with generated category and country navigation.
- Added a repository-local Codex maintenance skill, project instructions, and a tool-neutral maintenance manual so the workflow travels with the repository.
- Added deterministic freshness reporting and stricter country-page metadata validation.
- Completed a risk-stratified, 16-page AI benchmark with independent first-pass review, shuffled blind cross-review, and official-source adjudication. This was a sample, not a full-library re-verification.
- Corrected material current-policy details for Cambodia, Belize, Croatia, Italy, Sri Lanka, Portugal, New Zealand, the United States, and South Africa; added a future-policy warning for Japan.
