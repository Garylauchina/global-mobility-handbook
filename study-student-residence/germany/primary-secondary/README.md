...
- **申请者身份限制：** §16f针对符合条件的外国学生；法条对学校班级中不同国籍学生构成的要求是学校条件，不是只接收那些国籍的申请人。学生交换、普通学校居留及家属居留应分别适用，不能把学校录取当作家长可获居留的依据。
...
- **申请者身份限制：** 本块记录儿童在当地的受教育安排，不是独立移民资格。若依父母身份办理家庭团聚，须按§32等规则核对儿童年龄、婚姻状况及父母居留类型；父母的合法居留不是凭儿童获学校名额自动取得。
